    ...
    <tr>
        <td>
            <div style="padding: 0 20px;">
				...
				<p> Votre carte va être traduite si nécessaire et être envoyée pour arriver dans les temps pour la fête dans son centre. Vous en trouverez également une copie dans ce message.<br/><br/>
...
<br/><br/>
				...
				<p>Merci de votre engagement à nos côtés. Recevez nos chaleureuses salutations.</p>
                ...
                <p>
				 ...
				 <p> Votre lettre va être traduite si nécessaire et lui être envoyée dans les meilleurs délais. Vous en trouverez également une copie dans ce message.<br/>
				  ...
				  En cas de questions sur la correspondance avec votre filleul ou sur le parrainage en général, nous restons volontiers à votre disposition au numéro ci-dessous ou par email.<br/><p>

				  <p>Tél : 024 434 21 24 (lundi à vendredi : 8h00-16h00 ) <br/>
				  E-Mail: info@compassion.ch</p>
				  
				<p>Merci de tout coeur de votre engagement concret pour changer la vie d’un enfant.</p>
				...
				<p>	Carole Rochat <br/>
					Département parrainages</p>

					<p>	Compassion Suisse<br/>
						Rue Galilée 3<br/>
						1400 Yverdon-les-Bains<br/><br/>
