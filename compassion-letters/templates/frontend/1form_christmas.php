...
<form action="" class="compassion-letter-form" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="medium-12 large-6 column">
            ...
            <div class="row">
                ...
                <div class="small-8 columns">
                    <textarea maxlength="1500" required data-msg="<?php _e('Nachricht erforderlich', 'compassion-letters'); ?>" name="message" class="input-field clear-pdf-on-change"></textarea>
        ...
        <div class="medium-12 large-6 column">
            ...
            <div class="row choose-template radio-wrapper">
                ...
                <div class="medium-3 columns">
                    <input required data-msg="<?php _e('Vorlage erforderlich', 'compassion-letters'); ?>" type="radio" id="template1" class="clear-pdf-on-change" checked="checked"  value="noel2017" name="template" /><label><?php _e('Vorlage 1', 'compassion-letters'); ?></label><label for="template1" class="template-label">
                ...
                <div class="medium-3 columns">
                    <input required data-msg="<?php _e('Vorlage erforderlich', 'compassion-letters'); ?>" type="radio" id="template2" class="clear-pdf-on-change" value="Switzerland" name="template" /><label><?php _e('Vorlage 2', 'compassion-letters'); ?></label><label for="template2" class="template-label">
                        <img src="<?php echo COMPASSION_LETTERS_PLUGIN_DIR_URL; ?>assets/images/Switzerland-preview.jpg" />
                        <div class="hover-overlay">
                ...
                <div class="medium-3 columns">
                    <input required data-msg="<?php _e('Vorlage erforderlich' , 'compassion-letters'); ?>" type="radio" id="template3" class="clear-pdf-on-change" value="birds2" name="template" /><label><?php _e('Vorlage 3', 'compassion-letters'); ?></label><label for="template3" class="template-label">
                        <img src="<?php echo COMPASSION_LETTERS_PLUGIN_DIR_URL; ?>assets/images/birds2-preview.jpg" />
                        <div class="hover-overlay">
                ...
                <div class="medium-3 columns">
                    <input required data-msg="<?php _e('Vorlage erforderlich' , 'compassion-letters'); ?>" type="radio" id="template4" class="clear-pdf-on-change" value="abstract1" name="template" /><label><?php _e('Vorlage 4', 'compassion-letters'); ?></label><label for="template4" class="template-label">
                        <img src="<?php echo COMPASSION_LETTERS_PLUGIN_DIR_URL; ?>assets/images/abstract1-preview.jpg" />
                        <div class="hover-overlay">
                ...
                <div class="medium-3 columns">
                    <input required data-msg="<?php _e('Vorlage erforderlich' , 'compassion-letters'); ?>" type="radio" id="template5" class="clear-pdf-on-change" value="Football" name="template" /><label><?php _e('Vorlage 5', 'compassion-letters'); ?></label><label for="template5" class="template-label">
                        <img src="<?php echo COMPASSION_LETTERS_PLUGIN_DIR_URL; ?>assets/images/Football-preview.jpg" />
                        <div class="hover-overlay">
                ...
                <div class="medium-3 columns">
                    <input required data-msg="<?php _e('Vorlage erforderlich' , 'compassion-letters'); ?>" type="radio" id="template6" class="clear-pdf-on-change" value="bday3" name="template" /><label><?php _e('Vorlage 6', 'compassion-letters'); ?></label><label for="template6" class="template-label">
                        <img src="<?php echo COMPASSION_LETTERS_PLUGIN_DIR_URL; ?>assets/images/bday3-preview.jpg" />
                        <div class="hover-overlay">
                ...
                <div class="medium-3 columns">
                    <input required data-msg="<?php _e('Vorlage erforderlich' , 'compassion-letters'); ?>" type="radio" id="template7" class="clear-pdf-on-change" value="BirthdayCakes" name="template" /><label><?php _e('Vorlage 7', 'compassion-letters'); ?></label><label for="template7" class="template-label">
                        <img src="<?php echo COMPASSION_LETTERS_PLUGIN_DIR_URL; ?>assets/images/BirthdayCakes-preview.jpg" />
                        <div class="hover-overlay">
                            <h5 class="text-uppercase"><?php _e('Vorlage 7 auswählen', 'compassion-letters'); ?></h5>
                        </div>
                    </label>
                </div>

                <div class="medium-3 columns">
                    <input required data-msg="<?php _e('Vorlage erforderlich' , 'compassion-letters'); ?>" type="radio" id="template8" class="clear-pdf-on-change" value="Dove" name="template" /><label><?php _e('Vorlage 8', 'compassion-letters'); ?></label><label for="template8" class="template-label">
                        <img src="<?php echo COMPASSION_LETTERS_PLUGIN_DIR_URL; ?>assets/images/Dove-preview.jpg" />
                        <div class="hover-overlay">
                            <h5 class="text-uppercase"><?php _e('Vorlage 8 auswählen', 'compassion-letters'); ?></h5>
                        </div>
                    </label>
                </div>
    ...
    <div id="loading-modal" class="reveal" data-reveal aria-labelledby="modalTitle" aria-hidden="true" role="dialog">
        <div class="content">
            ...
            <h4 class="send-success"><?php _e('Ihr Brief wurde verschickt.', 'compassion-letters') ?></h4>
            <h4 class="send-fail"><?php _e('Es ist ein Fehler!', 'compassion-letters') ?></h4>
            <p class="send-fail"><?php _e('Bitte überprüfen Sie Ihre Referenznummer und die Nummer Ihres Kindes.', 'compassion-letters') ?></p>
