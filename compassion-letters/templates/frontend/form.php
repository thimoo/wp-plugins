    ...
    <div class="row">
        ...
        <div class="medium-12 large-6 column">
            ...
            <div class="row">
	            ...
	            <br/>	  <br/>	                  <small><a href="mailto:info@compassion.ch?subject=<?php _e('Ich finde meine Nummer gerade nicht! Bitte sendet  die Informationen per E-Mail', 'compassion-letters'); ?>&body=<?php _e('Vorname, Nachname', 'compassion-letters'); ?>:"><?php _e('Ich finde meine Nummer gerade nicht! Bitte senden Sie mir die Informationen per E-Mail. (Das kann einen Arbeitstag dauern)', 'compassion-letters'); ?></a> </small>
