...
<table cellpadding="0" cellspacing="0" border="0" id="backgroundTable">
    <tr>
        <td>
            ...
            <h1 style="text-align: center; padding: 25px 0;">Es ist ein neuer Brief eingegangen</h1>
            ...
            <div style="padding: 0 30px;">
                ...
                <ul>
                    ...
                    <li><?php _e('Patenkindnummer','compassion'); ?>: <?php echo $form_data['patenkind']; ?></li>
                    <li><?php _e('Patenkind - Name','compassion'); ?>: <?php echo $form_data['patenkind_name']; ?></li>
                </ul>
            </div>
