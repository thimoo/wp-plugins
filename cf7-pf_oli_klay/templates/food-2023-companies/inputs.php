...
<input type="hidden" id="type_flag" name="type_flag" value="food-2023-comp">
<!--<div class="row">-->
...
<div class="row don_unique"> <!--  style="display: none;">-->
    ...
    <div class="small-12 medium-12 columns">
        <div class="row">
            ...
            <div class="small-12 medium-4 columns">
                <button id="default_bt_value" class="button button-beige buttondonation" value="10000" >10000.- CHF</button>
            </div>
        </div>
